...
//todo: placeholder code from andrew's backend protoype, not needed for tasks yet
public enum SermonEnum {
    NOT_FOUND_E("Error: Sermon not found."),
    /*
